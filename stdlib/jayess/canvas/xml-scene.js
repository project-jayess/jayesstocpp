...
const sharedAttributes = [
  ...
  "mouse-select",
  "mouse-select-color",
  "mouse-select-padding",
  "mouse-select-corners",
  "text-input",
  "text-cursor",
  "text-cursor-width",
  "text-cursor-height",
...
function normalizeShared(node, context) {
  ...
  return {
    ...
    textSelectPadding: sizeAttribute(attributes, "text-select-padding", 0),
    textSelectCorners: cornersAttribute(attributes, "text-select-corners", null),
    mouseSelect: booleanAttribute(attributes, "mouse-select", false),
    mouseTextSelection: null,
    mouseSelectColor: colorAttribute(attributes, "mouse-select-color", null),
    mouseSelectPadding: sizeAttribute(attributes, "mouse-select-padding", 0),
    mouseSelectCorners: cornersAttribute(attributes, "mouse-select-corners", null),
    textInput: booleanAttribute(attributes, "text-input", false),
    textInputFocused: false,
    textCursorIndex: 0,
    textCursorVisible: true,
    textCursorLastTick: 0,
    textCursorColor: colorAttribute(attributes, "text-cursor", rgb(0, 0, 0)),
    textCursorWidth: sizeAttribute(attributes, "text-cursor-width", 1),
    textCursorHeight: sizeAttribute(attributes, "text-cursor-height", 0),
    textCursorCorners: cornersAttribute(attributes, "text-cursor-corners", null),
    textCursorSpeed: numberAttribute(attributes, "text-cursor-speed", 1),
    textUndoStack: [],
    textRedoStack: [],
    textLastEditMillis: 0,
...
function normalizeShape(node, context) {
  ...
  var shape = {
    ...
    textSelectPadding: shared.textSelectPadding,
    textSelectCorners: shared.textSelectCorners,
    mouseSelect: shared.mouseSelect,
    mouseTextSelection: shared.mouseTextSelection,
    mouseSelectColor: shared.mouseSelectColor,
    mouseSelectPadding: shared.mouseSelectPadding,
    mouseSelectCorners: shared.mouseSelectCorners,
    textInput: shared.textInput,
    textInputFocused: shared.textInputFocused,
    textCursorIndex: shared.textCursorIndex,
    textCursorVisible: shared.textCursorVisible,
    textCursorLastTick: shared.textCursorLastTick,
    textCursorColor: shared.textCursorColor,
    textCursorWidth: shared.textCursorWidth,
    textCursorHeight: shared.textCursorHeight,
    textCursorCorners: shared.textCursorCorners,
    textCursorSpeed: shared.textCursorSpeed,
    textUndoStack: shared.textUndoStack,
    textRedoStack: shared.textRedoStack,
    textLastEditMillis: shared.textLastEditMillis,
