...
This module is intentionally a compact text helper layer. It does not parse HTML, sanitize arbitrary HTML documents, provide CSS selectors, or expose browser APIs.
