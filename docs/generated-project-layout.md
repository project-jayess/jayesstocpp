...
The intended generated-project direction is export-level reachable symbol emission for ordinary named imports. Metadata should make this reviewable by recording requested import names, reachable exports, retained declarations, pruned declarations where practical, retained native artifacts, and whole-module fallback reasons. See [reachable-symbol-emission.md](./reachable-symbol-emission.md).
