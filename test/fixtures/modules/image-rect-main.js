...
export function run() {
  ...
  var transparentPixel = getPixel(transparentFilled, 0, 0);
  ...
  return [
    ...
    alphaPixel.green,
    alphaPixel.blue,
    transparentPixel.red,
    transparentPixel.green,
    transparentPixel.blue,
    transparentPixel.alpha,
    clippedPixel.green,
