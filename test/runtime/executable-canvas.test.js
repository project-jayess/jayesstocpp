...
int main() {
  ...
  require(std::get<double>(items[2]) == 255.0, "fillEllipse red pixel");
  require(std::get<double>(items[3]) == 0.0, "fillEllipse green channel");
  require(std::get<double>(items[4]) == 255.0, "drawEllipse green pixel");
  require(std::get<double>(items[5]) == 255.0, "drawPolyline blue pixel");
  ...
  require(std::get<double>(items[12]) == 77.0, "drawPolygon pixel");
  ...
  require(std::holds_alternative<double>(items[16]), "additional primitive pixel");
  require(std::holds_alternative<double>(items[17]), "additional outline primitive pixel");
  require(std::get<double>(items[18]) == 140.0, "quadraticCurve pixel");
  require(std::get<double>(items[19]) == 150.0, "bezierCurve pixel");
  require(std::holds_alternative<double>(items[20]), "canvas text pixel");
  ...
  auto sizeError = thrown_message(${namespace}::invalidSize);
  require(sizeError.find("shape width and height must be non-negative") != std::string::npos, "invalid size diagnostic");
  auto triangleError = thrown_message(${namespace}::invalidTriangle);
  require(triangleError.find("fillTriangle expects exactly three points") != std::string::npos, "invalid triangle diagnostic");
