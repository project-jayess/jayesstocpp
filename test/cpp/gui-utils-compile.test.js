...
compileTest("transpileFile GUI utility modules compile with the available C++ compiler", (t) => {
  const targetDir = createManagedTempDir(t, "builtin-gui-utils-project-compile");
