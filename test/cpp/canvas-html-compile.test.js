...
compileTest("transpileFile canvas HTML/CSS fixture compiles with the available C++ compiler", (t) => {
  const targetDir = createManagedTempDir(t, "canvas-html-compile");
  ...
  assert.ok(cppFiles.some((file) => file.includes("stdlib_jayess_canvas_index_js.cpp")));
});
