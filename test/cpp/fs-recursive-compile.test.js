...
compileTest("transpileFile recursive filesystem helper fixture compiles with the available C++ compiler", (t) => {
  const targetDir = createManagedTempDir(t, "fs-recursive-compile");
  ...
  assert.ok(cppFiles.some((file) => file.includes("stdlib_jayess_fs_index_js.cpp")));
});
