...
compileTest("transpileFile built-in terminal module project compiles with the available C++ compiler", (t) => {
  const targetDir = createManagedTempDir(t, "builtin-terminal-project-compile");
