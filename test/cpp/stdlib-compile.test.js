...
const stdlibCompileCases = [
  ...
  ["transpileFile crypto pem module project compiles with the available C++ compiler", "crypto-pem-project-compile", "test/fixtures/modules/crypto-pem-main.js"],
  ...
  ["transpileFile image bytes helper project compiles with the available C++ compiler", "image-bytes-project-compile", "test/fixtures/modules/image-bytes-main.js"],
  ["transpileFile image bulk rectangle helper project compiles with the available C++ compiler", "image-rect-project-compile", "test/fixtures/modules/image-rect-main.js"],
  ["transpileFile image subimage helper project compiles with the available C++ compiler", "image-subimage-project-compile", "test/fixtures/modules/image-subimage-main.js"],
