...
compileTest("transpileFile http signed-session helper output compiles", (t) => {
  const targetDir = createManagedTempDir(t, "http-session-compile");
  ...
  assert.ok(cppFiles.some((file) => file.includes("stdlib_jayess_http_session_js.cpp")));
});
