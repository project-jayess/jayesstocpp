...
compileTest("transpileFile built-in watch module project compiles with the available C++ compiler", (t) => {
  const targetDir = createManagedTempDir(t, "builtin-watch-project-compile");
